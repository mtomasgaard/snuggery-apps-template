...
NOT_SHOWN = {
    ...
    'text': ' '.join([
        ...
        'of the disc is shown only where a fit extends there. Single stars are drawn only within',
        'about 500 pc of the Sun, where Gaia\'s parallaxes are good enough to place them.',
        ...
        'licence was reachable. Uranus\'s rings are thin lines at their measured radii: a few',
        'kilometres wide, they are far too narrow to draw to scale. Neptune\'s rings are not shown.',
